...
const shapeClasses: Record<BrandImageIconShape, string> = {
  ...
  /* allow-arbitrary: rounded-[1.2rem] + shadow-[0_10px_28px_...] — ember-tile chassis, no canonical token */
  ...
  /* allow-arbitrary: bg-white/[0.04] + shadow-[0_8px_22px_...] — soft icon chassis (not subpanel chassis pattern), no canonical token */
