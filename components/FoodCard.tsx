...
export default function FoodCard({
  ...
  return (
    <button
      ...
      className={
        selected
          ? "group relative min-h-52 w-full touch-manipulation select-none overflow-hidden rounded-[2rem] border-2 border-orange-400/90 bg-zinc-950 text-left shadow-[0_24px_70px_rgba(255,106,0,0.36)] ring-2 ring-orange-400/35 transition-all duration-300 ease-out hover:scale-105 hover:shadow-[0_30px_90px_rgba(255,106,0,0.46)] focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-300/70 active:scale-[0.98] sm:min-h-64 lg:min-h-72"
          : "group relative min-h-52 w-full touch-manipulation select-none overflow-hidden rounded-[2rem] border border-white/10 bg-zinc-950 text-left shadow-[0_14px_45px_rgba(0,0,0,0.38)] transition-all duration-300 ease-out hover:scale-105 hover:border-[#FF6A00]/70 hover:shadow-[0_26px_80px_rgba(255,106,0,0.34)] focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-300/60 active:scale-[0.98] sm:min-h-64 lg:min-h-72"
      }
    >
      {!showImage && (
      ...
      <div className={`absolute inset-x-0 bottom-0 p-5 ${selected ? "pr-16" : "pr-5"}`}>
        <h3 className="line-clamp-2 text-2xl font-black leading-none tracking-[-0.04em] text-white drop-shadow-[0_2px_16px_rgba(0,0,0,0.72)] sm:text-3xl">
          {title}
        </h3>
