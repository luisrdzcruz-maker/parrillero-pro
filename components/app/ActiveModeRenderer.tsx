...
import { ParrilladaModeScreen } from "@/components/app/modes/ParrilladaModeScreen";
import { PlanModeScreen } from "@/components/app/modes/PlanModeScreen";
...
export function ActiveModeRenderer({ mode, home, coccion, menu, guardados }: ActiveModeRendererProps) {
  if (mode === "inicio") return <HomeModeScreen {...home} />;
  if (mode === "plan") return <PlanModeScreen />;
  if (mode === "coccion") return <CoccionModeScreen {...coccion} />;
  if (mode === "menu") return <MenuModeScreen {...menu} />;
  if (mode === "parrillada") return <ParrilladaModeScreen />;
