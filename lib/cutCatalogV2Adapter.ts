...
const cutCatalogV2Rows: readonly CutCatalogV2Row[] = [
  ...
  catalogRow({
    ...
    animal: "pork",
    category: "bbq_basic",
    cookingProfileId: "sausage_direct_gentle",
    prepProfileId: "sausage_no_extra_salt",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    requiredPhases: list("preheat|direct_gentle|turn_often|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 10, max: 18 },
    rest: { min: 3, max: 5 },
    hasFatCap: false,
    fatCapBehavior: "none",
    flareUpRisk: "medium",
    requiresMoveOnFlareup: true,
    warningCodes: list("split_risk|flare_up_risk|cook_gently|move_to_indirect_on_flareup|hide_doneness_selector"),
    prepWarningCodes: list("usually_already_seasoned|avoid_heavy_salt"),
    saltStrategy: "already_seasoned",
    saltTimingMinutes: { min: 0, max: 5 },
    saltAmountGuidance: "none_or_very_light",
    saltSurfaceGuidance: "outside_only_if_needed",
  }),
  catalogRow({
    cutId: "chorizo_criollo",
    variantId: "default",
    animal: "pork",
    category: "bbq_basic",
    cookingProfileId: "sausage_direct_gentle",
  ...
  catalogRow({
    ...
    animal: "beef",
    category: "ground",
    cookingProfileId: "burger_direct",
    prepProfileId: "burger_salt_just_before",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    requiredPhases: list("preheat|direct_grill|flip|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 8, max: 14 },
    rest: { min: 2, max: 5 },
    hasFatCap: false,
    ...
    flareUpRisk: "medium",
    requiresMoveOnFlareup: true,
    warningCodes: list("ground_meat_safety|required_safe_final_temp|avoid_pressing_burgers|hide_doneness_selector"),
    prepWarningCodes: list("salt_just_before_ground_meat|ground_meat_safety"),
    saltStrategy: "salt_just_before",
    saltTimingMinutes: { min: 0, max: 5 },
    saltAmountGuidance: "moderate",
    saltSurfaceGuidance: "both_sides",
  }),
  catalogRow({
    cutId: "chicken_wings",
    variantId: "default",
    animal: "chicken",
    category: "poultry",
    cookingProfileId: "poultry_small_safe_direct",
    prepProfileId: "poultry_wings_dry_brine",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    requiredPhases: list("preheat|direct_grill|turn_often|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 18, max: 30 },
    rest: { min: 3, max: 5 },
    hasFatCap: false,
    fatCapBehavior: "none",
    flareUpRisk: "medium",
    requiresMoveOnFlareup: true,
    warningCodes: list(
      "poultry_safe_temp|required_safe_final_temp|separate_raw_chicken_tools|flare_up_risk|move_to_indirect_on_flareup|hide_doneness_selector",
    ),
    prepWarningCodes: list("separate_raw_chicken_tools|air_dry_skin_for_crispness|poultry_safe_temp"),
    saltStrategy: "dry_brine",
    saltTimingMinutes: { min: 60, max: 720 },
    saltAmountGuidance: "moderate",
    saltSurfaceGuidance: "skin_all_sides",
  }),
  catalogRow({
    cutId: "pork_belly_slices",
    variantId: "default",
    animal: "pork",
    category: "pork_grill",
    cookingProfileId: "pork_fatty_direct",
    prepProfileId: "pork_belly_salt_cured_guard",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    requiredPhases: list("preheat|direct_render|turn_often|move_indirect_on_flareup|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 8, max: 18 },
    rest: { min: 3, max: 6 },
    hasFatCap: true,
    fatCapBehavior: "direct_sear_then_brief_fat_edge_render",
    flareUpRisk: "high",
    requiresMoveOnFlareup: true,
    warningCodes: list("safe_pork_temp|flare_up_risk|move_to_indirect_on_flareup|avoid_over_salting_if_cured|hide_doneness_selector"),
    prepWarningCodes: list("avoid_over_salting_if_cured|safe_pork_temp|pat_dry_before_sear"),
    saltStrategy: "cured_salt_aware",
    saltTimingMinutes: { min: 30, max: 240 },
    saltAmountGuidance: "light_to_moderate",
    saltSurfaceGuidance: "all_sides_light_if_cured",
  }),
  catalogRow({
    cutId: "asparagus",
    variantId: "spears",
  ...
  catalogRow({
    ...
    flareUpRisk: "low",
    requiresMoveOnFlareup: false,
    warningCodes: list("sugar_char_risk|visual_doneness_only|serve_immediately"),
    prepWarningCodes: list("salt_butter_after_or_just_before"),
    saltStrategy: "salt_after_or_just_before",
    saltTimingMinutes: { min: 0, max: 5 },
    saltAmountGuidance: "light",
    saltSurfaceGuidance: "all_sides",
  }),
  catalogRow({
    ...
    animal: "vegetable",
    category: "vegetables",
    cookingProfileId: "vegetables_roast_indirect",
    prepProfileId: "vegetable_salt_just_before",
    temperatureMode: "visual_only",
    allowedDoneness: [],
    hideDonenessSelector: true,
    requiredPhases: list("preheat|indirect_roast|visual_check"),
    setup: { min: 8, max: 12 },
    active: { min: 25, max: 45 },
    rest: { min: 0, max: 2 },
    hasFatCap: false,
    fatCapBehavior: "none",
    flareUpRisk: "low",
    requiresMoveOnFlareup: false,
    warningCodes: list("undercooked_center_risk_if_thick|visual_doneness_only"),
    prepWarningCodes: list("par_cook_optional_if_thick|salt_before_or_after"),
    saltStrategy: "salt_just_before",
    saltTimingMinutes: { min: 0, max: 5 },
    saltAmountGuidance: "light",
    saltSurfaceGuidance: "all_sides",
  ...
  catalogRow({
    ...
    flareUpRisk: "low",
    requiresMoveOnFlareup: false,
    warningCodes: list("water_release_risk|visual_doneness_only|serve_immediately"),
    prepWarningCodes: list("salt_late_to_avoid_moisture"),
    saltStrategy: "salt_just_before",
    saltTimingMinutes: { min: 0, max: 5 },
    saltAmountGuidance: "light",
    saltSurfaceGuidance: "all_sides",
  ...
  catalogRow({
    ...
    flareUpRisk: "low",
    requiresMoveOnFlareup: false,
    warningCodes: list("skin_char_risk|overcook_risk|visual_doneness_only"),
    prepWarningCodes: list("salt_just_before_or_after"),
    saltStrategy: "salt_just_before",
    saltTimingMinutes: { min: 0, max: 5 },
    saltAmountGuidance: "light",
    saltSurfaceGuidance: "all_sides",
...
const cookingProfileV2Rows: readonly CookingProfileV2[] = [
  ...
  cookingProfile({
    profileId: "sausage_direct_gentle",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    defaultMethod: "direct_gentle_turn_often",
    expectedPhases: list("preheat|direct_gentle|turn_often|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 10, max: 22 },
    rest: { min: 3, max: 5 },
    requiredWarnings: list("split_risk|flare_up_risk|cook_gently|move_to_indirect_on_flareup|hide_doneness_selector"),
  }),
  cookingProfile({
    profileId: "burger_direct",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    defaultMethod: "direct_grill_to_safe_temp",
    expectedPhases: list("preheat|direct_grill|flip|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 8, max: 14 },
    rest: { min: 2, max: 5 },
    requiredWarnings: list("ground_meat_safety|required_safe_final_temp|avoid_pressing_burgers|hide_doneness_selector"),
  }),
  cookingProfile({
    profileId: "poultry_small_safe_direct",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    defaultMethod: "direct_then_indirect_to_safe_temp",
    expectedPhases: list("preheat|direct_grill|turn_often|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 18, max: 30 },
    rest: { min: 3, max: 5 },
    requiredWarnings: list(
      "poultry_safe_temp|required_safe_final_temp|separate_raw_chicken_tools|flare_up_risk|move_to_indirect_on_flareup|hide_doneness_selector",
    ),
  }),
  cookingProfile({
    profileId: "pork_fatty_direct",
    temperatureMode: "safe_temp",
    allowedDoneness: [],
    hideDonenessSelector: true,
    defaultMethod: "direct_render_then_indirect_if_needed",
    expectedPhases: list("preheat|direct_render|turn_often|move_indirect_on_flareup|finish_to_safe_temp|short_rest"),
    setup: { min: 8, max: 12 },
    active: { min: 8, max: 18 },
    rest: { min: 3, max: 6 },
    requiredWarnings: list("safe_pork_temp|flare_up_risk|move_to_indirect_on_flareup|avoid_over_salting_if_cured|hide_doneness_selector"),
  }),
  cookingProfile({
...
const prepProfileV2Rows: readonly PrepProfileV2[] = [
  ...
  {
    profileId: "sausage_no_extra_salt",
    appliesToCookingProfiles: list("sausage_direct_gentle"),
    ...
    saltSurfaceGuidance: "outside_only_if_needed",
    prepWarningCodes: list("usually_already_seasoned|avoid_heavy_salt"),
    titleEn: "Usually already seasoned",
  },
  {
    profileId: "burger_salt_just_before",
    appliesToCookingProfiles: list("burger_direct"),
    prepLeadTimeMinutes: { min: 0, max: 5 },
    saltStrategy: "salt_just_before",
    saltTimingMinutes: { min: 0, max: 5 },
    saltAmountGuidance: "moderate",
    saltSurfaceGuidance: "both_sides",
    prepWarningCodes: list("salt_just_before_ground_meat|ground_meat_safety"),
    titleEn: "Salt just before cooking",
  },
  {
    profileId: "poultry_wings_dry_brine",
    appliesToCookingProfiles: list("poultry_small_safe_direct"),
    prepLeadTimeMinutes: { min: 60, max: 720 },
    saltStrategy: "dry_brine",
    saltTimingMinutes: { min: 60, max: 720 },
    saltAmountGuidance: "moderate",
    saltSurfaceGuidance: "skin_all_sides",
    prepWarningCodes: list("separate_raw_chicken_tools|air_dry_skin_for_crispness|poultry_safe_temp"),
    titleEn: "Salt 1-12 h before",
  },
  {
    profileId: "pork_belly_salt_cured_guard",
    appliesToCookingProfiles: list("pork_fatty_direct"),
    ...
    saltSurfaceGuidance: "all_sides_light_if_cured",
    prepWarningCodes: list("avoid_over_salting_if_cured|safe_pork_temp|pat_dry_before_sear"),
    titleEn: "Salt 30 min-4 h; watch cured salt",
  },
  {
...
const cutAliases: Record<string, { cutId: string; variantId?: string }> = {
  ...
  bone_in_ribeye_long_bone: { cutId: "tomahawk", variantId: "long_bone" },
  burger: { cutId: "burger_patty", variantId: "default" },
  burgers: { cutId: "burger_patty", variantId: "default" },
  chicken_wing: { cutId: "chicken_wings", variantId: "default" },
  chicken_wings: { cutId: "chicken_wings", variantId: "default" },
  chorizo: { cutId: "chorizo_criollo", variantId: "default" },
  chuleton: { cutId: "bone_in_ribeye", variantId: "chuleton" },
  entrecote: { cutId: "ribeye", variantId: "steak" },
  "frenched ribeye": { cutId: "tomahawk", variantId: "long_bone" },
  lomo_alto: { cutId: "ribeye", variantId: "steak" },
  "long bone ribeye": { cutId: "tomahawk", variantId: "long_bone" },
  "long-bone ribeye": { cutId: "tomahawk", variantId: "long_bone" },
  ...
  panceta: { cutId: "pork_belly_slices", variantId: "default" },
  pollo_entero: { cutId: "whole_chicken", variantId: "whole" },
  salchichas: { cutId: "sausages", variantId: "default" },
  short_ribs: { cutId: "beef_short_ribs", variantId: "rack_or_individual" },
  costillas: { cutId: "pork_ribs", variantId: "default" },
  corn: { cutId: "corn_on_cob", variantId: "whole" },
  maiz: { cutId: "corn_on_cob", variantId: "whole" },
  peppers: { cutId: "bell_peppers", variantId: "halves" },
  potatoes: { cutId: "potato_halves", variantId: "halves" },
