  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(249,115,22,0.22),transparent_30%),linear-gradient(180deg,#020617_0%,#0f172a_48%,#020617_100%)] px-4 py-5 text-slate-100 sm:py-8">
      <div className="mx-auto max-w-[560px]">
        {!hasAnyContent ? (
          /* allow-arbitrary: rounded-[2rem] + shadow-[0_30px_100px_...] — empty-state hero card, no canonical token */
          ...
          <>
            {/* allow-arbitrary: rounded-[2.25rem] + bg-[radial-gradient(...)] + shadow-[...] — share hero chassis, no canonical token */}
            <section className="overflow-hidden rounded-[2.25rem] border border-orange-300/25 bg-[radial-gradient(circle_at_14%_0%,rgba(251,146,60,0.34),transparent_33%),linear-gradient(145deg,rgba(15,23,42,0.98),rgba(2,6,23,0.98)_58%,rgba(67,20,7,0.78))] shadow-[0_34px_120px_rgba(249,115,22,0.16)] ring-1 ring-inset ring-white/[0.05]">
              <div className="relative p-5 sm:p-7">
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className={`${ds.text.body11} font-semibold text-slate-400`}>
                          Premium cooking card
                        </p>
                      </div>
                    </div>
                    <p className={`rounded-full border border-orange-300/25 bg-orange-500/15 px-3 py-1 ${ds.text.body9} font-black uppercase tracking-[0.22em] text-orange-200`}>
                      Shared
                    </p>
                  </div>
                  ...
                  {setupVisual && (
                    /* allow-arbitrary: rounded-[1.75rem] — setup visual frame radius, no canonical ds.radius.* tier */
                    <div className="mt-6 overflow-hidden rounded-[1.75rem] border border-orange-200/20 bg-slate-950 shadow-2xl shadow-black/35 ring-1 ring-inset ring-white/[0.04]">
                      <div className="relative h-48 sm:h-56">
                        ...
                        <p className={`absolute left-3 top-3 rounded-full border border-white/15 bg-black/45 px-3 py-1 ${ds.text.body10} font-black uppercase tracking-[0.16em] text-orange-100 backdrop-blur-md`}>
                          Setup visual
                        </p>
                      </div>
                    </div>
